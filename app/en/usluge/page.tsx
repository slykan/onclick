...
import { services } from "@/lib/data.en";

export const metadata: Metadata = {
  title: "Services | On-Click",
  description:
    "Website, webshop and mobile app development, maintenance, hosting and SEO optimization.",
  alternates: {
    canonical: "https://www.on-click.hr/en/usluge",
    languages: {
...
export default function UslugePageEn() {
  return (
    <>
      <PageHero
        eyebrow="Services"
        title="What can we do for you?"
        description="We provide complete IT solutions tailored to your business — from building your site to long-term support."
      />
